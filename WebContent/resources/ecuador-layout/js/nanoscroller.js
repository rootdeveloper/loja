	...
	NanoScroll = (function () {
		...
		NanoScroll.prototype.generate = function () {
			...
			if (cssRule != null) {
				...
				if (isRTL) {
					this.pane.addClass('nano-panel-rtl');
				}
			}
			return this;
		};
		...
		NanoScroll.prototype.reset = function () {
			var content, contentHeight, contentPosition, contentStyle, contentStyleOverflowY, paneBottom, paneHeight, paneOuterHeight, paneTop, parentMaxHeight, left, right, sliderHeight;
			if (this.iOSNativeScrolling) {
